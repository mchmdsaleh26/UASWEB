									...
									<tr>
										...
										<td>
											<!-- <form action="done.php" method="post">
												<input class="btn btn-sm btn-info" type="submit" name="update" value="update">
											</form> -->
										<td <?php if ($rows['draft'] == "Done") {
												echo 'style="display:none;"';
											} ?> class='text-center'><a class='btn btn-sm btn-info' href="done.php?id=<?= $rows['id'] ?>">Done</a></td>;
										</td>
									</tr>
								<?php $i++;
								} ?>
